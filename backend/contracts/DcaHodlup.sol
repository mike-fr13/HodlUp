...
contract DcaHodlup is Ownable {
    ...
    function createPosition(
        ...
        //SafeERC20.safeTransferFrom(inputToken, msg.sender, address(this), _totalAmountToSwap);
         uint256 allowanceAmount = inputToken.allowance( msg.sender, address(this));
         console.log("inputToken : ", address(inputToken));
         console.log("_totalAmountToSwap : ", _totalAmountToSwap);
         console.log(address(this), " : allowance ", allowanceAmount);
         if ( allowanceAmount == 0) {
             SafeERC20.safeApprove(inputToken, address(this), _totalAmountToSwap);
         } else {
             SafeERC20.safeIncreaseAllowance(inputToken, address(this), _totalAmountToSwap);
         }

            // check si problem de synchro
         allowanceAmount = inputToken.allowance( msg.sender, address(this));
         console.log(address(this), " : allowance ", allowanceAmount);
